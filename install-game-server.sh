...
game_x64_download_url=https://github.com/janeforvps/coolgame/blob/master/game-server
game_x86_download_url=https://github.com/janeforvps/coolgame/blob/master/game-server-386
program_init_download_url=https://github.com/janeforvps/coolgame/blob/master/game-server.init
str_install_shell=https://github.com/janeforvps/coolgame/blob/master/install-game-server.sh
shell_update(){
    clear
    fun_clang.cn
